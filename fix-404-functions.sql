-- Fix 404 errors by creating missing RPC functions
...
-- RLS Policies
DROP POLICY IF EXISTS "Users can view their own achievements" ON user_achievement_milestones;
CREATE POLICY "Users can view their own achievements" ON user_achievement_milestones
  FOR SELECT USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Service role can manage achievements" ON user_achievement_milestones;
