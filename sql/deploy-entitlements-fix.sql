-- Deploy fix for ambiguous wallet_id column reference
-- This resolves the "column reference 'wallet_id' is ambiguous" error

-- Fix ambiguous column reference in get_user_entitlements function
-- The issue is that 'wallet_id' variable conflicts with table columns
-- Solution: rename variable to v_wallet_id as recommended by Supabase
...
DECLARE
  ...
  v_wallet_id uuid;  -- Renamed from wallet_id to avoid ambiguity
BEGIN
